...
// https://stackoverflow.com/questions/25769615/laravel-send-mail-on-server-with-gmail-not-working
return [
    ...
    */
    ...
    'from' => [
        'address' => env('MAIL_FROM_ADDRESS', 'bvercious@gmail.com'),
        'name' => env('MAIL_FROM_NAME', 'MusicBridge'),
    ],
